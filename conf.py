...
html_theme_options = {
    ...
    "source_repository": "https://github.com/eliemichel/sphinx_literate",
    "source_branch": "main",
    "source_directory": ".",
}
...
html_static_path = ['doc/images', 'doc/theme']
